...
function addWeatherToDisplay(weatherData) {
    ...
    displayWeather.innerHTML +=
        ...
        <div class="weatherGrid">
            ...
            <h4 id="feelsLike" class="weatherLines">Feels like ${
                weatherData.main.feels_like
            } ℃</h4>
            <img id=icon class="weatherIcon" src="${
                iconUrl + weatherData.weather[0].icon + ".png"
            }" alt="Weather icon">
            <h4 id="description" class="weatherLines">${
                weatherData.weather[0].description
            }</h4>
            <h4 id="wind" class="weatherLines">Wind: ${
                weatherData.wind.speed
            } km/h</h4>
            <h4 id="humidity" class="weatherLines">Humidity: ${
                weatherData.main.humidity
            } %</h4>
            <h4 id="visibility" class="weatherLines">Visibility: ${
